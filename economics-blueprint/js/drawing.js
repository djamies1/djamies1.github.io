/* ============================================================
   drawing.js — boot-time generated drafting furniture only.
   The disclaimer band, the money-flow boxes and the illustrative
   spend/earn curve are unique and hand-authored in index.html;
   only the sheet-edge zones are generated here.
   ============================================================ */
