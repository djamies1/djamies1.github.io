...
function build(isMobile, onProgress) {
  ...
  if (MODE === 'player') {
    ...
    else tl.progress(POSTER).pause();   // poster frame: drawn craft + overview panel
  }
...
function sceneBus(tl) {
  tl.addLabel('bus', 14)
    ...
    .to('#panel-1', { autoAlpha: 1, y: 0, duration: 1.3, ease: 'power2.out' }, 20.6);
}
...
function sceneArray(tl) {
  tl.addLabel('array', 25)
    ...
    .to('#panel-2', { autoAlpha: 1, y: 0, duration: 1.3, ease: 'power2.out' }, 34.2);
}
...
function sceneOisl(tl) {
  tl.addLabel('oisl', 38)
    ...
    .to('#panel-3', { autoAlpha: 1, y: 0, duration: 1.3, ease: 'power2.out' }, 44.6);
}
...
function sceneAvionics(tl) {
  tl.addLabel('avionics', 49)
    ...
    .to('#panel-4', { autoAlpha: 1, y: 0, duration: 1.3, ease: 'power2.out' }, 55.4);
}
